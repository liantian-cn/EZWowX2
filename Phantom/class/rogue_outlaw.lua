...
addonTable.SPEC.SpellList = {
    ...
    [17] = { spellId = 13750, description = "冲动" },
    [18] = { spellId = 51690, description = "影舞步" },
    [19] = { spellId = 271877, description = "刀锋冲刺" },
    [20] = { spellId = 315341, description = "正中眉心" },
    [21] = { spellId = 13877, description = "剑刃乱舞" },
    [22] = { spellId = 195475, description = "抓钩" },
    [23] = { spellId = 1214909, description = "命运骨骰" },
}

-- Entries without a source charge count bar use the user-approved Phantom 0..8 fallback.
addonTable.SPEC.ChargeList = {
    [1] = { spellId = 195475, description = "抓钩", minValue = 0, maxValue = 8 },
}
