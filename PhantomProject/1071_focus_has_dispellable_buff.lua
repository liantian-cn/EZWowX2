...
通过 AuraSlot 显示团队成员可驱散或偷取的焦点增益效果。
...
local function InitFrame()
    ...
    -- AuraContainer updates aura instances internally; fixed focus-token identity and raid dispel capability need external invalidation.
