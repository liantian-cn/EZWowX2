...
if MidnightAddonDB == nil then
    MidnightAddonDB = {}
end

addonTable.FPS = MidnightAddonDB.FPS or 24
addonTable.RangeCheck = MidnightAddonDB.RangeCheck or 40
...
do
    ...
    local function SetValue(value)
        ...
        MidnightAddonDB.RangeCheck = value
    end
