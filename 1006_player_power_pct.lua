...
使用UnitPowerPercent和cell.zeroToOneCurve直接生成显示颜色，避免读取secret百分比后自行计算。
...
local function InitFrame()
    ...
    local function updateCell()
        cell:setCell(UnitPowerPercent("player", UnitPowerType("player"), false, cell.zeroToOneCurve))
    end
